...
private[mysql4s] object TypeConverter:
  ...
  given ShortConverter: TypeConverter[Short] with
    ...
    def fromNative(v: CVoidPtr): WithZone[Short] = !v.asInstanceOf[CType]
  ...
  given LongConverter: TypeConverter[Long] with
    ...
    def fromNative(v: CVoidPtr): WithZone[Long] = !v.asInstanceOf[CType]
  ...
  given FloatConverter: TypeConverter[Float] with
    ...
    def fromNative(v: CVoidPtr): WithZone[Float] = !v.asInstanceOf[CType]
  ...
  given DoubleConverter: TypeConverter[Double] with
    ...
    def fromNative(v: CVoidPtr): WithZone[Double] =
      val ptr = alloc[CDouble]()
      !ptr = atof(v.asInstanceOf[CString])
      !ptr
  ...
  given BooleanConverter: TypeConverter[Boolean] with
    ...
    def fromNative(v: CVoidPtr): WithZone[Boolean] = !v.asInstanceOf[CType]
