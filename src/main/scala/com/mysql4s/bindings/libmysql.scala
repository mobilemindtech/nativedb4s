...
object predef:
  ...
  private[mysql4s] trait CEnumU[T](using eq: T =:= UInt):
...
object structs:
  ...
  opaque type MYSQL_BIND = CStruct19[Ptr[CUnsignedLongInt], Ptr[Boolean], CVoidPtr, Ptr[Boolean], Ptr[CUnsignedChar], CFuncPtr2[Ptr[NET], Ptr[Byte], Unit], CFuncPtr3[Ptr[Byte], Ptr[MYSQL_FIELD], Ptr[Ptr[CUnsignedChar]], Unit], CFuncPtr3[Ptr[Byte], Ptr[MYSQL_FIELD], Ptr[Ptr[CUnsignedChar]], Unit], CUnsignedLongInt, CUnsignedLongInt, CUnsignedLongInt, CUnsignedInt, CUnsignedInt, enum_field_types, Boolean, Boolean, Boolean, Boolean, Ptr[Byte]]
  object MYSQL_BIND:
    given _tag: Tag[MYSQL_BIND] = Tag.materializeCStruct19Tag[Ptr[CUnsignedLongInt], Ptr[Boolean], CVoidPtr, Ptr[Boolean], Ptr[CUnsignedChar], CFuncPtr2[Ptr[NET], Ptr[Byte], Unit], CFuncPtr3[Ptr[Byte], Ptr[MYSQL_FIELD], Ptr[Ptr[CUnsignedChar]], Unit], CFuncPtr3[Ptr[Byte], Ptr[MYSQL_FIELD], Ptr[Ptr[CUnsignedChar]], Unit], CUnsignedLongInt, CUnsignedLongInt, CUnsignedLongInt, CUnsignedInt, CUnsignedInt, enum_field_types, Boolean, Boolean, Boolean, Boolean, Ptr[Byte]]
    def apply()(using Zone): Ptr[MYSQL_BIND] = scala.scalanative.unsafe.alloc[MYSQL_BIND](1)
    def apply(length : Ptr[CUnsignedLongInt], is_null : Ptr[Boolean], buffer : CVoidPtr, error : Ptr[Boolean], row_ptr : Ptr[CUnsignedChar], store_param_func : CFuncPtr2[Ptr[NET], Ptr[MYSQL_BIND], Unit], fetch_result : CFuncPtr3[Ptr[MYSQL_BIND], Ptr[MYSQL_FIELD], Ptr[Ptr[CUnsignedChar]], Unit], skip_result : CFuncPtr3[Ptr[MYSQL_BIND], Ptr[MYSQL_FIELD], Ptr[Ptr[CUnsignedChar]], Unit], buffer_length : CUnsignedLongInt, offset : CUnsignedLongInt, length_value : CUnsignedLongInt, param_number : CUnsignedInt, pack_length : CUnsignedInt, buffer_type : enum_field_types, error_value : Boolean, is_unsigned : Boolean, long_data_used : Boolean, is_null_value : Boolean, extension : Ptr[Byte])(using Zone): Ptr[MYSQL_BIND] =
      val ____ptr = apply()
    ...
    extension (struct: MYSQL_BIND)
      ...
      def buffer : CVoidPtr = struct._3
      def buffer_=(value: CVoidPtr): Unit = !struct.at3 = value
...
object types:
  export _root_.com.mysql4s.bindings.structs.*
  export _root_.com.mysql4s.bindings.aliases.*
  export _root_.com.mysql4s.bindings.enumerations.*

object all:
  export _root_.com.mysql4s.bindings.enumerations.Item_result
  export _root_.com.mysql4s.bindings.enumerations.Item_udftype
  export _root_.com.mysql4s.bindings.enumerations.SERVER_STATUS_flags_enum
  export _root_.com.mysql4s.bindings.enumerations.enum_compression_algorithm
  export _root_.com.mysql4s.bindings.enumerations.enum_cursor_type
  export _root_.com.mysql4s.bindings.enumerations.enum_field_types
  export _root_.com.mysql4s.bindings.enumerations.enum_mysql_set_option
  export _root_.com.mysql4s.bindings.enumerations.enum_mysql_stmt_state
  export _root_.com.mysql4s.bindings.enumerations.enum_mysql_timestamp_type
  export _root_.com.mysql4s.bindings.enumerations.enum_resultset_metadata
  export _root_.com.mysql4s.bindings.enumerations.enum_server_command
  export _root_.com.mysql4s.bindings.enumerations.enum_session_state_type
  export _root_.com.mysql4s.bindings.enumerations.enum_stmt_attr_type
  export _root_.com.mysql4s.bindings.enumerations.mysql_enum_shutdown_level
  export _root_.com.mysql4s.bindings.enumerations.mysql_option
  export _root_.com.mysql4s.bindings.enumerations.mysql_protocol_type
  export _root_.com.mysql4s.bindings.enumerations.mysql_ssl_fips_mode
  export _root_.com.mysql4s.bindings.enumerations.mysql_ssl_mode
  export _root_.com.mysql4s.bindings.enumerations.mysql_status
  export _root_.com.mysql4s.bindings.enumerations.net_async_status
  export _root_.com.mysql4s.bindings.aliases.MYSQL_FIELD_OFFSET
  export _root_.com.mysql4s.bindings.aliases.MYSQL_ROW
  export _root_.com.mysql4s.bindings.aliases.MYSQL_ROW_OFFSET
  export _root_.com.mysql4s.bindings.aliases.Udf_func_add
  export _root_.com.mysql4s.bindings.aliases.Udf_func_any
  export _root_.com.mysql4s.bindings.aliases.Udf_func_clear
  export _root_.com.mysql4s.bindings.aliases.Udf_func_deinit
  export _root_.com.mysql4s.bindings.aliases.Udf_func_double
  export _root_.com.mysql4s.bindings.aliases.Udf_func_init
  export _root_.com.mysql4s.bindings.aliases.Udf_func_longlong
  export _root_.com.mysql4s.bindings.aliases.Udf_func_string
  export _root_.com.mysql4s.bindings.aliases.list_walk_action
  export _root_.com.mysql4s.bindings.aliases.my_socket
  export _root_.com.mysql4s.bindings.aliases.my_ulonglong
  export _root_.com.mysql4s.bindings.aliases.size_t
  export _root_.com.mysql4s.bindings.aliases.uint64_t
  export _root_.com.mysql4s.bindings.aliases.va_list
  export _root_.com.mysql4s.bindings.structs.CHARSET_INFO
  export _root_.com.mysql4s.bindings.structs.Init_commands_array
  export _root_.com.mysql4s.bindings.structs.LIST
  export _root_.com.mysql4s.bindings.structs.MEM_ROOT
  export _root_.com.mysql4s.bindings.structs.MYSQL
  export _root_.com.mysql4s.bindings.structs.MYSQL_BIND
  export _root_.com.mysql4s.bindings.structs.MYSQL_DATA
  export _root_.com.mysql4s.bindings.structs.MYSQL_FIELD
  export _root_.com.mysql4s.bindings.structs.MYSQL_METHODS
  export _root_.com.mysql4s.bindings.structs.MYSQL_PLUGIN_VIO
  export _root_.com.mysql4s.bindings.structs.MYSQL_PLUGIN_VIO_INFO
  export _root_.com.mysql4s.bindings.structs.MYSQL_RES
  export _root_.com.mysql4s.bindings.structs.MYSQL_ROWS
  export _root_.com.mysql4s.bindings.structs.MYSQL_RPL
  export _root_.com.mysql4s.bindings.structs.MYSQL_STMT
  export _root_.com.mysql4s.bindings.structs.MYSQL_STMT_EXT
  export _root_.com.mysql4s.bindings.structs.MYSQL_TIME
  export _root_.com.mysql4s.bindings.structs.MY_CHARSET_INFO
  export _root_.com.mysql4s.bindings.structs.NET
  export _root_.com.mysql4s.bindings.structs.UDF_ARGS
  export _root_.com.mysql4s.bindings.structs.UDF_INIT
  export _root_.com.mysql4s.bindings.structs.Vio
  export _root_.com.mysql4s.bindings.structs.ZSTD_CCtx
  export _root_.com.mysql4s.bindings.structs.ZSTD_CCtx_s
  export _root_.com.mysql4s.bindings.structs.ZSTD_DCtx
  export _root_.com.mysql4s.bindings.structs.ZSTD_DCtx_s
  export _root_.com.mysql4s.bindings.structs.auth_plugin_t
  export _root_.com.mysql4s.bindings.structs.character_set
  export _root_.com.mysql4s.bindings.structs.mysql_compress_context
  export _root_.com.mysql4s.bindings.structs.mysql_zlib_compress_context
  export _root_.com.mysql4s.bindings.structs.mysql_zstd_compress_context
  export _root_.com.mysql4s.bindings.structs.rand_struct
  export _root_.com.mysql4s.bindings.structs.st_mysql_client_plugin
  export _root_.com.mysql4s.bindings.structs.st_mysql_client_plugin_AUTHENTICATION
  export _root_.com.mysql4s.bindings.structs.st_mysql_options
  export _root_.com.mysql4s.bindings.structs.st_mysql_options_extention
  export _root_.com.mysql4s.bindings.functions.ER_CLIENT
  export _root_.com.mysql4s.bindings.functions.check_scramble
  export _root_.com.mysql4s.bindings.functions.check_scramble_323
  export _root_.com.mysql4s.bindings.functions.create_random_string
  export _root_.com.mysql4s.bindings.functions.finish_client_errs
  export _root_.com.mysql4s.bindings.functions.generate_sha256_scramble
  export _root_.com.mysql4s.bindings.functions.get_salt_from_password
  export _root_.com.mysql4s.bindings.functions.get_salt_from_password_323
  export _root_.com.mysql4s.bindings.functions.get_tty_password
  export _root_.com.mysql4s.bindings.functions.hash_password
  export _root_.com.mysql4s.bindings.functions.init_client_errs
  export _root_.com.mysql4s.bindings.functions.list_add
  export _root_.com.mysql4s.bindings.functions.list_cons
  export _root_.com.mysql4s.bindings.functions.list_delete
  export _root_.com.mysql4s.bindings.functions.list_free
  export _root_.com.mysql4s.bindings.functions.list_length
  export _root_.com.mysql4s.bindings.functions.list_reverse
  export _root_.com.mysql4s.bindings.functions.list_walk
  export _root_.com.mysql4s.bindings.functions.make_password_from_salt
  export _root_.com.mysql4s.bindings.functions.make_password_from_salt_323
  export _root_.com.mysql4s.bindings.functions.make_scrambled_password
  export _root_.com.mysql4s.bindings.functions.make_scrambled_password_323
  export _root_.com.mysql4s.bindings.functions.my_net_init
  export _root_.com.mysql4s.bindings.functions.my_net_local_init
  export _root_.com.mysql4s.bindings.functions.my_net_read
  export _root_.com.mysql4s.bindings.functions.my_net_set_read_timeout
  export _root_.com.mysql4s.bindings.functions.my_net_set_retry_count
  export _root_.com.mysql4s.bindings.functions.my_net_set_write_timeout
  export _root_.com.mysql4s.bindings.functions.my_net_write
  export _root_.com.mysql4s.bindings.functions.my_rnd
  export _root_.com.mysql4s.bindings.functions.my_thread_end
  export _root_.com.mysql4s.bindings.functions.my_thread_init
  export _root_.com.mysql4s.bindings.functions.myodbc_remove_escape
  export _root_.com.mysql4s.bindings.functions.mysql_affected_rows
  export _root_.com.mysql4s.bindings.functions.mysql_autocommit
  export _root_.com.mysql4s.bindings.functions.mysql_bind_param
  export _root_.com.mysql4s.bindings.functions.mysql_binlog_close
  export _root_.com.mysql4s.bindings.functions.mysql_binlog_fetch
  export _root_.com.mysql4s.bindings.functions.mysql_binlog_open
  export _root_.com.mysql4s.bindings.functions.mysql_change_user
  export _root_.com.mysql4s.bindings.functions.mysql_character_set_name
  export _root_.com.mysql4s.bindings.functions.mysql_client_find_plugin
  export _root_.com.mysql4s.bindings.functions.mysql_client_register_plugin
  export _root_.com.mysql4s.bindings.functions.mysql_close
  export _root_.com.mysql4s.bindings.functions.mysql_commit
  export _root_.com.mysql4s.bindings.functions.mysql_compress_context_deinit
  export _root_.com.mysql4s.bindings.functions.mysql_compress_context_init
  export _root_.com.mysql4s.bindings.functions.mysql_data_seek
  export _root_.com.mysql4s.bindings.functions.mysql_debug
  export _root_.com.mysql4s.bindings.functions.mysql_default_compression_level
  export _root_.com.mysql4s.bindings.functions.mysql_dump_debug_info
  export _root_.com.mysql4s.bindings.functions.mysql_eof
  export _root_.com.mysql4s.bindings.functions.mysql_errno
  export _root_.com.mysql4s.bindings.functions.mysql_errno_to_sqlstate
  export _root_.com.mysql4s.bindings.functions.mysql_error
  export _root_.com.mysql4s.bindings.functions.mysql_escape_string
  export _root_.com.mysql4s.bindings.functions.mysql_fetch_field
  export _root_.com.mysql4s.bindings.functions.mysql_fetch_field_direct
  export _root_.com.mysql4s.bindings.functions.mysql_fetch_fields
  export _root_.com.mysql4s.bindings.functions.mysql_fetch_lengths
  export _root_.com.mysql4s.bindings.functions.mysql_fetch_row
  export _root_.com.mysql4s.bindings.functions.mysql_fetch_row_nonblocking
  export _root_.com.mysql4s.bindings.functions.mysql_field_count
  export _root_.com.mysql4s.bindings.functions.mysql_field_seek
  export _root_.com.mysql4s.bindings.functions.mysql_field_tell
  export _root_.com.mysql4s.bindings.functions.mysql_free_result
  export _root_.com.mysql4s.bindings.functions.mysql_free_result_nonblocking
  export _root_.com.mysql4s.bindings.functions.mysql_free_ssl_session_data
  export _root_.com.mysql4s.bindings.functions.mysql_get_character_set_info
  export _root_.com.mysql4s.bindings.functions.mysql_get_client_info
  export _root_.com.mysql4s.bindings.functions.mysql_get_client_version
  export _root_.com.mysql4s.bindings.functions.mysql_get_host_info
  export _root_.com.mysql4s.bindings.functions.mysql_get_option
  export _root_.com.mysql4s.bindings.functions.mysql_get_proto_info
  export _root_.com.mysql4s.bindings.functions.mysql_get_server_info
  export _root_.com.mysql4s.bindings.functions.mysql_get_server_version
  export _root_.com.mysql4s.bindings.functions.mysql_get_ssl_cipher
  export _root_.com.mysql4s.bindings.functions.mysql_get_ssl_session_data
  export _root_.com.mysql4s.bindings.functions.mysql_get_ssl_session_reused
  export _root_.com.mysql4s.bindings.functions.mysql_hex_string
  export _root_.com.mysql4s.bindings.functions.mysql_info
  export _root_.com.mysql4s.bindings.functions.mysql_init
  export _root_.com.mysql4s.bindings.functions.mysql_insert_id
  export _root_.com.mysql4s.bindings.functions.mysql_kill
  export _root_.com.mysql4s.bindings.functions.mysql_list_dbs
  export _root_.com.mysql4s.bindings.functions.mysql_list_fields
  export _root_.com.mysql4s.bindings.functions.mysql_list_processes
  export _root_.com.mysql4s.bindings.functions.mysql_list_tables
  export _root_.com.mysql4s.bindings.functions.mysql_load_plugin
  export _root_.com.mysql4s.bindings.functions.mysql_load_plugin_v
  export _root_.com.mysql4s.bindings.functions.mysql_more_results
  export _root_.com.mysql4s.bindings.functions.mysql_next_result
  export _root_.com.mysql4s.bindings.functions.mysql_next_result_nonblocking
  export _root_.com.mysql4s.bindings.functions.mysql_num_fields
  export _root_.com.mysql4s.bindings.functions.mysql_num_rows
  export _root_.com.mysql4s.bindings.functions.mysql_options
  export _root_.com.mysql4s.bindings.functions.mysql_options4
  export _root_.com.mysql4s.bindings.functions.mysql_ping
  export _root_.com.mysql4s.bindings.functions.mysql_plugin_get_option
  export _root_.com.mysql4s.bindings.functions.mysql_plugin_options
  export _root_.com.mysql4s.bindings.functions.mysql_query
  export _root_.com.mysql4s.bindings.functions.mysql_read_query_result
  export _root_.com.mysql4s.bindings.functions.mysql_real_connect
  export _root_.com.mysql4s.bindings.functions.mysql_real_connect_dns_srv
  export _root_.com.mysql4s.bindings.functions.mysql_real_connect_nonblocking
  export _root_.com.mysql4s.bindings.functions.mysql_real_escape_string
  export _root_.com.mysql4s.bindings.functions.mysql_real_escape_string_quote
  export _root_.com.mysql4s.bindings.functions.mysql_real_query
  export _root_.com.mysql4s.bindings.functions.mysql_real_query_nonblocking
  export _root_.com.mysql4s.bindings.functions.mysql_refresh
  export _root_.com.mysql4s.bindings.functions.mysql_reset_connection
  export _root_.com.mysql4s.bindings.functions.mysql_reset_server_public_key
  export _root_.com.mysql4s.bindings.functions.mysql_result_metadata
  export _root_.com.mysql4s.bindings.functions.mysql_rollback
  export _root_.com.mysql4s.bindings.functions.mysql_row_seek
  export _root_.com.mysql4s.bindings.functions.mysql_row_tell
  export _root_.com.mysql4s.bindings.functions.mysql_select_db
  export _root_.com.mysql4s.bindings.functions.mysql_select_db_nonblocking
  export _root_.com.mysql4s.bindings.functions.mysql_send_query
  export _root_.com.mysql4s.bindings.functions.mysql_send_query_nonblocking
  export _root_.com.mysql4s.bindings.functions.mysql_server_end
  export _root_.com.mysql4s.bindings.functions.mysql_server_init
  export _root_.com.mysql4s.bindings.functions.mysql_session_track_get_first
  export _root_.com.mysql4s.bindings.functions.mysql_session_track_get_next
  export _root_.com.mysql4s.bindings.functions.mysql_set_character_set
  export _root_.com.mysql4s.bindings.functions.mysql_set_local_infile_default
  export _root_.com.mysql4s.bindings.functions.mysql_set_local_infile_handler
  export _root_.com.mysql4s.bindings.functions.mysql_set_server_option
  export _root_.com.mysql4s.bindings.functions.mysql_shutdown
  export _root_.com.mysql4s.bindings.functions.mysql_sqlstate
  export _root_.com.mysql4s.bindings.functions.mysql_ssl_set
  export _root_.com.mysql4s.bindings.functions.mysql_stat
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_affected_rows
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_attr_get
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_attr_set
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_bind_param
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_bind_result
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_close
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_data_seek
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_errno
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_error
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_execute
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_fetch
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_fetch_column
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_field_count
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_free_result
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_init
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_insert_id
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_next_result
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_num_rows
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_param_count
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_param_metadata
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_prepare
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_reset
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_result_metadata
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_row_seek
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_row_tell
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_send_long_data
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_sqlstate
  export _root_.com.mysql4s.bindings.functions.mysql_stmt_store_result
  export _root_.com.mysql4s.bindings.functions.mysql_store_result
  export _root_.com.mysql4s.bindings.functions.mysql_store_result_nonblocking
  export _root_.com.mysql4s.bindings.functions.mysql_thread_end
  export _root_.com.mysql4s.bindings.functions.mysql_thread_id
  export _root_.com.mysql4s.bindings.functions.mysql_thread_init
  export _root_.com.mysql4s.bindings.functions.mysql_thread_safe
  export _root_.com.mysql4s.bindings.functions.mysql_use_result
  export _root_.com.mysql4s.bindings.functions.mysql_warning_count
  export _root_.com.mysql4s.bindings.functions.net_claim_memory_ownership
  export _root_.com.mysql4s.bindings.functions.net_clear
  export _root_.com.mysql4s.bindings.functions.net_end
  export _root_.com.mysql4s.bindings.functions.net_field_length
  export _root_.com.mysql4s.bindings.functions.net_field_length_checked
  export _root_.com.mysql4s.bindings.functions.net_field_length_ll
  export _root_.com.mysql4s.bindings.functions.net_field_length_size
  export _root_.com.mysql4s.bindings.functions.net_flush
  export _root_.com.mysql4s.bindings.functions.net_length_size
  export _root_.com.mysql4s.bindings.functions.net_realloc
  export _root_.com.mysql4s.bindings.functions.net_store_length
  export _root_.com.mysql4s.bindings.functions.net_write_command
  export _root_.com.mysql4s.bindings.functions.net_write_packet
  export _root_.com.mysql4s.bindings.functions.octet2hex
  export _root_.com.mysql4s.bindings.functions.randominit
  export _root_.com.mysql4s.bindings.functions.scramble
  export _root_.com.mysql4s.bindings.functions.scramble_323