...
private[mysql] object TypeConverter:
  ...
  given TypeConverter[String]:
    def fromNative(
        ...
        len: Int
    ): WithZone[String] = str.asInstanceOf[CString] |> toStr
  ...
  given TypeConverter[Int]:
    def fromNative(
        ...
        typ: enum_field_types,
        len: Int
    ): WithZone[Int] = !v.asInstanceOf[Ptr[CInt]]
  ...
  given TypeConverter[Short]:
    def fromNative(
        ...
        typ: enum_field_types,
        len: Int
    ): WithZone[Short] = !v.asInstanceOf[Ptr[CShort]]
  ...
  given TypeConverter[Long]:
    def fromNative(
        ...
        typ: enum_field_types,
        len: Int
    ): WithZone[Long] = !v.asInstanceOf[Ptr[CLongLong]]
  ...
  given TypeConverter[Float]:
    def fromNative(
        ...
        typ: enum_field_types,
        len: Int
    ): WithZone[Float] = !v.asInstanceOf[Ptr[CFloat]]
  ...
  given TypeConverter[Boolean]:
    def fromNative(
        ...
        typ: enum_field_types,
        len: Int
    ): WithZone[Boolean] = !v.asInstanceOf[Ptr[CBool]]
