package io.nativedb4s.mysql.bindings

import io.nativedb4s.mysql
...
object predef:
  private[mysql] trait CEnum[T](using eq: T =:= Int):
    given Tag[T] = Tag.Int.asInstanceOf[Tag[T]]
    extension (inline t: T)
      inline def int: CInt = eq.apply(t)
      inline def value: CInt = eq.apply(t)
  private[mysql] trait CEnumU[T](using eq: T =:= UInt):
...
@link("mysqlclient")
@extern
private[mysql] object extern_functions:
  import aliases.*
  import enumerations.*
  import structs.*
...
object all:
  export enumerations.Item_result
  export enumerations.Item_udftype
  export enumerations.SERVER_STATUS_flags_enum
  export enumerations.enum_compression_algorithm
  export enumerations.enum_cursor_type
  export enumerations.enum_field_types
  export enumerations.enum_mysql_set_option
  export enumerations.enum_mysql_stmt_state
  export enumerations.enum_mysql_timestamp_type
  export enumerations.enum_resultset_metadata
  export enumerations.enum_server_command
  export enumerations.enum_session_state_type
  export enumerations.enum_stmt_attr_type
  export enumerations.mysql_enum_shutdown_level
  export enumerations.mysql_option
  export enumerations.mysql_protocol_type
  export enumerations.mysql_ssl_fips_mode
  export enumerations.mysql_ssl_mode
  export enumerations.mysql_status
  export enumerations.net_async_status
  export aliases.MYSQL_FIELD_OFFSET
  export aliases.MYSQL_ROW
  export aliases.MYSQL_ROW_OFFSET
  export aliases.Udf_func_add
  export aliases.Udf_func_any
  export aliases.Udf_func_clear
  export aliases.Udf_func_deinit
  export aliases.Udf_func_double
  export aliases.Udf_func_init
  export aliases.Udf_func_longlong
  export aliases.Udf_func_string
  export aliases.list_walk_action
  export aliases.my_socket
  export aliases.my_ulonglong
  export aliases.size_t
  export aliases.uint64_t
  export aliases.va_list
  export structs.CHARSET_INFO
  export structs.Init_commands_array
  export structs.LIST
  export structs.MEM_ROOT
  export structs.MYSQL
  export structs.MYSQL_BIND
  export structs.MYSQL_DATA
  export structs.MYSQL_FIELD
  export structs.MYSQL_METHODS
  export structs.MYSQL_PLUGIN_VIO
  export structs.MYSQL_PLUGIN_VIO_INFO
  export structs.MYSQL_RES
  export structs.MYSQL_ROWS
  export structs.MYSQL_RPL
  export structs.MYSQL_STMT
  export structs.MYSQL_STMT_EXT
  export structs.MYSQL_TIME
  export structs.MY_CHARSET_INFO
  export structs.NET
  export structs.UDF_ARGS
  export structs.UDF_INIT
  export structs.Vio
  export structs.ZSTD_CCtx
  export structs.ZSTD_CCtx_s
  export structs.ZSTD_DCtx
  export structs.ZSTD_DCtx_s
  export structs.auth_plugin_t
  export structs.character_set
  export structs.mysql_compress_context
  export structs.mysql_zlib_compress_context
  export structs.mysql_zstd_compress_context
  export structs.rand_struct
  export structs.st_mysql_client_plugin
  export structs.st_mysql_client_plugin_AUTHENTICATION
  export structs.st_mysql_options
  export _root_.io.nativedb4s.mysql.bindings.structs.st_mysql_options_extention
  export _root_.io.nativedb4s.mysql.bindings.functions.ER_CLIENT
  export _root_.io.nativedb4s.mysql.bindings.functions.check_scramble
  export _root_.io.nativedb4s.mysql.bindings.functions.check_scramble_323
  export _root_.io.nativedb4s.mysql.bindings.functions.create_random_string
  export _root_.io.nativedb4s.mysql.bindings.functions.finish_client_errs
  export _root_.io.nativedb4s.mysql.bindings.functions.generate_sha256_scramble
  export _root_.io.nativedb4s.mysql.bindings.functions.get_salt_from_password
  export _root_.io.nativedb4s.mysql.bindings.functions.get_salt_from_password_323
  export _root_.io.nativedb4s.mysql.bindings.functions.get_tty_password
  export _root_.io.nativedb4s.mysql.bindings.functions.hash_password
  export _root_.io.nativedb4s.mysql.bindings.functions.init_client_errs
  export _root_.io.nativedb4s.mysql.bindings.functions.list_add
  export _root_.io.nativedb4s.mysql.bindings.functions.list_cons
  export _root_.io.nativedb4s.mysql.bindings.functions.list_delete
  export _root_.io.nativedb4s.mysql.bindings.functions.list_free
  export _root_.io.nativedb4s.mysql.bindings.functions.list_length
  export _root_.io.nativedb4s.mysql.bindings.functions.list_reverse
  export _root_.io.nativedb4s.mysql.bindings.functions.list_walk
  export _root_.io.nativedb4s.mysql.bindings.functions.make_password_from_salt
  export _root_.io.nativedb4s.mysql.bindings.functions.make_password_from_salt_323
  export _root_.io.nativedb4s.mysql.bindings.functions.make_scrambled_password
  export _root_.io.nativedb4s.mysql.bindings.functions.make_scrambled_password_323
  export _root_.io.nativedb4s.mysql.bindings.functions.my_net_init
  export _root_.io.nativedb4s.mysql.bindings.functions.my_net_local_init
  export _root_.io.nativedb4s.mysql.bindings.functions.my_net_read
  export _root_.io.nativedb4s.mysql.bindings.functions.my_net_set_read_timeout
  export _root_.io.nativedb4s.mysql.bindings.functions.my_net_set_retry_count
  export _root_.io.nativedb4s.mysql.bindings.functions.my_net_set_write_timeout
  export _root_.io.nativedb4s.mysql.bindings.functions.my_net_write
  export _root_.io.nativedb4s.mysql.bindings.functions.my_rnd
  export _root_.io.nativedb4s.mysql.bindings.functions.my_thread_end
  export _root_.io.nativedb4s.mysql.bindings.functions.my_thread_init
  export _root_.io.nativedb4s.mysql.bindings.functions.myodbc_remove_escape
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_affected_rows
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_autocommit
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_bind_param
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_binlog_close
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_binlog_fetch
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_binlog_open
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_change_user
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_character_set_name
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_client_find_plugin
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_client_register_plugin
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_close
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_commit
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_compress_context_deinit
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_compress_context_init
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_data_seek
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_debug
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_default_compression_level
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_dump_debug_info
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_eof
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_errno
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_errno_to_sqlstate
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_error
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_escape_string
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_fetch_field
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_fetch_field_direct
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_fetch_fields
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_fetch_lengths
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_fetch_row
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_fetch_row_nonblocking
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_field_count
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_field_seek
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_field_tell
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_free_result
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_free_result_nonblocking
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_free_ssl_session_data
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_get_character_set_info
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_get_client_info
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_get_client_version
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_get_host_info
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_get_option
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_get_proto_info
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_get_server_info
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_get_server_version
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_get_ssl_cipher
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_get_ssl_session_data
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_get_ssl_session_reused
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_hex_string
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_info
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_init
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_insert_id
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_kill
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_list_dbs
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_list_fields
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_list_processes
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_list_tables
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_load_plugin
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_load_plugin_v
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_more_results
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_next_result
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_next_result_nonblocking
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_num_fields
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_num_rows
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_options
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_options4
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_ping
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_plugin_get_option
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_plugin_options
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_query
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_read_query_result
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_real_connect
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_real_connect_dns_srv
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_real_connect_nonblocking
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_real_escape_string
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_real_escape_string_quote
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_real_query
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_real_query_nonblocking
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_refresh
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_reset_connection
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_reset_server_public_key
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_result_metadata
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_rollback
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_row_seek
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_row_tell
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_select_db
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_select_db_nonblocking
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_send_query
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_send_query_nonblocking
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_server_end
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_server_init
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_session_track_get_first
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_session_track_get_next
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_set_character_set
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_set_local_infile_default
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_set_local_infile_handler
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_set_server_option
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_shutdown
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_sqlstate
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_ssl_set
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stat
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_affected_rows
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_attr_get
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_attr_set
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_bind_param
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_bind_result
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_close
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_data_seek
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_errno
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_error
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_execute
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_fetch
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_fetch_column
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_field_count
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_free_result
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_init
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_insert_id
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_next_result
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_num_rows
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_param_count
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_param_metadata
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_prepare
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_reset
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_result_metadata
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_row_seek
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_row_tell
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_send_long_data
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_sqlstate
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_stmt_store_result
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_store_result
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_store_result_nonblocking
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_thread_end
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_thread_id
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_thread_init
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_thread_safe
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_use_result
  export _root_.io.nativedb4s.mysql.bindings.functions.mysql_warning_count
  export _root_.io.nativedb4s.mysql.bindings.functions.net_claim_memory_ownership
  export _root_.io.nativedb4s.mysql.bindings.functions.net_clear
  export _root_.io.nativedb4s.mysql.bindings.functions.net_end
  export _root_.io.nativedb4s.mysql.bindings.functions.net_field_length
  export _root_.io.nativedb4s.mysql.bindings.functions.net_field_length_checked
  export _root_.io.nativedb4s.mysql.bindings.functions.net_field_length_ll
  export _root_.io.nativedb4s.mysql.bindings.functions.net_field_length_size
  export _root_.io.nativedb4s.mysql.bindings.functions.net_flush
  export _root_.io.nativedb4s.mysql.bindings.functions.net_length_size
  export _root_.io.nativedb4s.mysql.bindings.functions.net_realloc
  export _root_.io.nativedb4s.mysql.bindings.functions.net_store_length
  export _root_.io.nativedb4s.mysql.bindings.functions.net_write_command
  export _root_.io.nativedb4s.mysql.bindings.functions.net_write_packet
  export _root_.io.nativedb4s.mysql.bindings.functions.octet2hex
  export _root_.io.nativedb4s.mysql.bindings.functions.randominit
  export _root_.io.nativedb4s.mysql.bindings.functions.scramble
  export _root_.io.nativedb4s.mysql.bindings.functions.scramble_323